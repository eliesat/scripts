...
grep -o -i -E 'C: [a-z][^<]*' ok  > /tmp/xtest/soubor1
...
grep -o -i -E '.*Expire' CCcam | sed "s#Expire##g"  > /tmp/xtest/soubor3
...
grep -o -i -E 'C: [a-z][^<]*' CCcam | sed -n '2p'  > /tmp/xtest/soubor4
...
grep -o -i -E 'C: [a-z][^<]*' CCcam | sed -n '2p'  > /tmp/xtest/soubor5
...
grep -o -i -E 'C: [a-z][^<]*' CCcam | sed -n '2p'  > /tmp/xtest/soubor6
...
grep -o -i -E 'C: [^<]*' /tmp/xtest/CCcam > /tmp/xtest/soubor17
